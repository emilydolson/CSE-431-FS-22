...
**FINALS WEEK! MAKE SURE TO SCHEDULE YOUR FINAL!**

# Optional extra videos

These didn't fit into this year's schedule, but feel free to check them out if you're interested!

Machine learning optimization methods are another approach to finding approximate solutions to problems (i.e. they can act as approximation algorithms). Evolutionary computation is one that I happen to know a lot about because I do research on it, so I'm presenting it here as an example of this sort of optimization algorithm.
